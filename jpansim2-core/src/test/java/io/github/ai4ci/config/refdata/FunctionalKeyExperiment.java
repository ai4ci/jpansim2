...
public class FunctionalKeyExperiment {
	...
	public static class KeyFunction<X, Y> {
		...
		public static <X, Y> KeyFunction<X, Y> create(
	...
	void testLabelled() {
		...
		assertEquals(
			Factor.fromLabel(ExampleEnum.class, "test_one"),
			ExampleEnum.ONE
		);
		assertEquals(
			Factor.fromLabel(ExampleEnum.class, "THREE"),
			ExampleEnum.THREE
		);
	}
	...
	void testExperiment() {
		...
		var instance = ImmutableTestImmutable.builder()
			.setInt(1)
			.setString("hello")
			.build();
		var instance2 = ImmutableTestImmutable.builder()
			.setInt(1)
			.setString("hello")
			.build();
