 ...
 *
 * <p>
 * Provides parameters used to generate a random graph under the G(n,p) model.
 * The graph generator is used during the {@code setupOutbreak} stage by the
 * model builder to populate the social network graph.
 *
 * @author Rob Challen
 */
@Value.Immutable
...
public interface ErdosReyniConfiguration extends NetworkConfiguration {
	 ...
	 *
	 * <p>
	 * The default supplies a simple parameterisation of the G(n,p) model with
