 ...
 *
 * <p>
 * This interface describes a simple age stratified demography used during setup
 * and baselining. It supplies an empirical age distribution and a function
 * expressing the odds of contact as a function of age difference.
 * Implementations are used when creating person stubs and when computing
 * relationship strengths between agents.
 *
 * <p>
 * Downstream uses include setup and builder code such as
...
public interface AgeStratifiedDemography extends LocationAwareDemography {
	 ...
	 *
	 * <p>
	 * The default supplies a simple age distribution and an odds function that
	 ...
	 *
	 * <p>
	 * This helper converts the supplied base probability {@code p} into an
	 ...
	 *
	 * <p>
	 * This helper is a convenience used during outbreak setup when the builder
	 * needs to create a population quickly. Downstream callers include the setup
	 * stage in {@link io.github.ai4ci.flow.builders.DefaultModelBuilder}. The
	 * returned {@link ModifiablePerson} has an
	 * {@link ImmutablePersonDemographic} with an age sampled from
	 * {@link #getAgeDistribution()}.
	 *
	 ...
	 *
	 * <p>
	 * When {@link #getOddsContactFromAgeDifference()} is an
	 * {@link EmpiricalFunction} this method returns a function that has been
	 * normalised against the joint age distribution. The normalisation produces
	 * a baseline odds function suitable for combining with other contact
	 * modifiers.
	 *
	 ...
	 *
	 * <p>
	 * The function returns a non‑negative odds ratio for a given absolute age
	 * difference; callers typically normalize or combine this function with
	 ...
	 * {@link #adjustedProbabilityContact(double, Person, Person)}. This is the
	 * canonical place to combine location and demographic contact modifiers.
	 *
