 ...
 *
 * <p>
 * This interface captures the distributions and thresholds used by the
 * phenomenological in‑host model. It includes parameters for incubation, timing
 * of peak viral load and recovery, approximate peak viral load and immune
 * response, and immune waning.
 *
 * <p>
 * Several entries are subject to demographic adjustment via
 * {@link io.github.ai4ci.config.execution.DemographicAdjustment.Phenomenological}
 * and may be modified at runtime by the execution configuration. In particular
 ...
 * {@link io.github.ai4ci.abm.inhost.InHostPhenomenologicalState}. It is also
 * referenced by example code and tests.
 *
 * @author Rob Challen
 */
@Value.Immutable
...
public interface PhenomenologicalModel extends InHostConfiguration,
	 ...
	 *
	 * <p>
	 * The default values provide a compact set of distributions used in examples
	 * and tests. Downstream callers that rely on this simple default include the
	 * default in‑host phenomenological initialiser and example experiments.
	 *
	 ...
	 *
	 * <p>
	 * This is used in the phenomenological immune model to determine the
	 * amplitude of the host immune response and its effect on viral decay. It is
	 * not adjusted via the demographic adjustment interface in the standard
	 * configuration.
	 *
	 ...
	 *
	 * <p>
	 * This value is used to calibrate the shape and amplitude of the viral load
	 * trajectory. It is not directly adjusted by the demographic adjustment
	 ...
	 *
	 * <p>
	 * This parameter may be adjusted by
	 * {@link DemographicAdjustment.Phenomenological} implementations to
	 * represent age dependent differences in immune waning. Callers such as
	 * initialisers and immune decay updaters sample this distribution when
	 * computing immunity loss over time.
	 *
	 ...
	 *
	 * <p>
	 * This distribution is sampled by the default initialiser and by the viral
	 * load calibration code. It is adjustable by
	 * {@link DemographicAdjustment.Phenomenological} implementations, allowing
	 * age dependent scaling of incubation timing.
	 *
	 ...
	 *
	 * <p>
	 * This distribution is sampled when constructing the viral load model for an
	 * infected individual. It is not listed as adjustable in the
	 * {@link DemographicAdjustment.Phenomenological} interface and so remains
	 * constant across demographic groups unless modified elsewhere.
	 *
	 ...
	 *
	 * <p>
	 * Value is used by initialisers and state code to determine whether an
	 ...
	 *
	 * <p>
	 * This distribution is sampled when creating an individual's immune response
	 * trajectory and is used by the viral load/immune interaction routines.
	 *
	 ...
	 *
	 * <p>
	 * The {@link DemographicAdjustment.Phenomenological} may adjust this value
	 * via the {@code getPeakToRecoveryDelay} entry in certain demographic
	 * configurations; callers should consult the execution configuration's
	 * demographic adjustment before sampling if age dependent values are
	 * required.
	 *
