 ...
 * be copied in situ to a new immutable. Its basically an arraylist hidden so
 * deep cloning cannot happen. Its particularly used to expose one set of test
 * types to the test results class, without creating an army of clones.
 *
...
public class ShallowList<X> extends ArrayList<X> {
	...
	/**
	 * Combine this list with another, returning this list. This is a mutating
	 * operation, but allows chaining.
	 *
