 ...
 * {@link io.github.ai4ci.flow.builders.DefaultModelBuilder} where composition
 * keeps responsibilities separated and makes it easy to swap alternative
 * baseline strategies.
 *
 * <p>
 * Composition with {@link io.github.ai4ci.flow.builders.DefaultModelBuilder}:
 ...
 *
 * <p>
 * Downstream uses: the returned {@code ImmutableOutbreakBaseline} is used by
...
public interface DefaultOutbreakBaseliner {
	 ...
	 * <li>Compute expected contacts per person using {@link Calibration}.</li>
	 ...
	 * while guarding against pathological cases where the quick routine fails.
	 *
	 * @param builder  builder used to assemble the
	 *                 {@link ImmutableOutbreakBaseline}
	 * @param outbreak the outbreak used to compute aggregates and calibration
	 * @param sampler  a sampler available for any stochastic choices during
	 *                 baselining
	 * @return a built {@link ImmutableOutbreakBaseline} containing global priors
	 *         and calibration values
	 */
	default ImmutableOutbreakBaseline baselineOutbreak(
