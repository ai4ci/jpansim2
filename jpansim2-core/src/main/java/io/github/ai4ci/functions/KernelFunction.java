 ...
 *
 * <p>
 * Kernel functions are typically used for convolution operations and
 * probability distributions with discrete support. Supports multiple
 * implementations including empirical kernels, discrete functions, and Gaussian
 * kernels.
 */
@JsonTypeInfo(
		use = Id.NAME,
...
public interface KernelFunction {
	...
	/**
	 * The kernel function is defined over a discrete integer range from minimum
	 * to maximum.
	 *
	...
	default double value(int t) {
		return this.values()[t - this.getMinimum()];
	}
