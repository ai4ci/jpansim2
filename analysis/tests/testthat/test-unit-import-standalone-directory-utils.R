...
test_that(".inputter unit test", {
  ...
  testthat::expect(rlang::caller_env(n = 2)$ok,
    ...
    srcref = srcref(srcfile("../../R/import-standalone-directory-utils.R"), c(34, 1, 34+1, 1))
  )
})
...
test_that(".outputter unit test", {
  ...
  testthat::expect(rlang::caller_env(n = 2)$ok,
    failure_message = "Source link for failing @unit test.",
    srcref = srcref(srcfile("../../R/import-standalone-directory-utils.R"), c(87, 1, 87+1, 1))
  )
})
...
test_that(".locate_project unit test", {
  ...
  testthat::expect(rlang::caller_env(n = 2)$ok,
    failure_message = "Source link for failing @unit test.",
    srcref = srcref(srcfile("../../R/import-standalone-directory-utils.R"), c(148, 1, 148+1, 1))
  )
})
...
test_that(".here unit test", {
  ...
  testthat::expect(rlang::caller_env(n = 2)$ok,
    failure_message = "Source link for failing @unit test.",
    srcref = srcref(srcfile("../../R/import-standalone-directory-utils.R"), c(232, 1, 232+1, 1))
  )
})
