...
# Source: https://github.com/terminological/ggrrr/blob/HEAD/R/standalone-file-output-utils.R
# Generated by: pkgtools::use_standalone("terminological/ggrrr", "file-output-utils")
# ----------------------------------------------------------------------
#
# ---
