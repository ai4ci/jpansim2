...
# Source: https://github.com/terminological/ggrrr/blob/HEAD/R/standalone-directory-utils.R
# Generated by: pkgtools::use_standalone("terminological/ggrrr", "directory-utils")
# ----------------------------------------------------------------------
#
# ---
...
.locate_project = function(inputFile = NULL) {
  ...
  if (is.null(inputFile)) {
    inputFile = tryCatch(suppressWarnings(.this_script()), error = function(e) getwd())
  }
