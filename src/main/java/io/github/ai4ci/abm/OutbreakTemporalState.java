 ...
 */
public interface OutbreakTemporalState
		extends TemporalState<Outbreak>, Cloneable {
	 ...
	 *         decrease for the current state and the cumulative compliance
	 *         decrease from the history. It represents the overall decrease in
	 *         compliance compared to baseline over the course of the outbreak,
	 *         and is a measure of the impact of restrictions and/or disease on
	 *         compliance.
	 */
	 ...
	 * since the start of the outbreak. This is a key metric for understanding
	 * the overall scale of the outbreak and is used in various places such as to
	 * determine how many people are immune and to inform policy decisions.
	 *
	 * <br>
	 * A true value
	 *
	 * @return the total number of infections that have occurred since the start
	 *         of the outbreak.
	 */
	 ...
	 *         compared to baseline. This is the sum of the total mobility
	 *         decrease for the current state and the cumulative mobility
	 *         decrease from the history. It represents the overall decrease in
	 *         mobility compared to baseline over the course of the outbreak, and
	 *         is a measure of the impact of restrictions and/or disease.
	 */
	 ...
	 * hospitalisation at any given point in time since the start of the
	 * outbreak.
	 *
	 * A true value:<br>
	 * <br>
	 *
	 * @return the maximum number of people who have required hospitalisation at
	 *         any given point in time since the start of the outbreak.
	 */
	long getMaximumHospitalBurden();

	/**
	 * Maximum incidence is the highest number of new infections that have
	 * occurred in a single day since the start of the outbreak. This is a key
	 * metric for understanding the peak of the outbreak and is used in various
	 ...
	 * A true value:
	 *
	 * @return the highest number of new infections that have occurred in a
	 *         single day since the start of the outbreak.
	 */
	 ...
	 * given point in time versus all the non dead people. This is a key metric
	 * for understanding the overall scale of the outbreak and is used in various
	 * places such as to determine how many people are immune and to inform
	 * policy decisions.
	 *
	 * @return the number of people who are currently infected at a given point
	 *         in time versus all the non dead people.
	 */
	double getPrevalence();

	/**
	 * Time to maximum incidence is the time it takes for the outbreak to reach
	 * its peak incidence. This is a key metric for understanding the speed of
	 * the outbreak and is used in various places such as to determine the timing
	 * of interventions and to inform policy decisions.
	 *
	 * A true value:<br>
	 * <br>
	 *
