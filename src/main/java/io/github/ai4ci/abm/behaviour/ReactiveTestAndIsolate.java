...
/**
 * Reactive test and isolate behaviour model. This is the behaviour of a person
 * who will seek a test if they have symptoms, and then self isolate if they are
 * positive. This is a common policy for many diseases, and is used as a
 * baseline for comparison with other compliant behaviour models.
 *
 * @author Rob Challen
 */
public enum ReactiveTestAndIsolate implements BehaviourModel, DefaultNoTesting {
	...
	/**
	 * Awaiting PCR result. If positive then self isolate, if negative then
	...
	/**
	 * Self isolating. Will stay in this state for the duration of the infectious
	 * period, then return to normal behaviour.
	 */
	SELF_ISOLATE {
		@Override
		public State.BehaviourState nextState(
