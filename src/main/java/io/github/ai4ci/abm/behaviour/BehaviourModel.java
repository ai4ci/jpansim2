 ...
 * history refer to the previous state. This does not override any
 * BehaviourState functions but is here because
 * {@link io.github.ai4ci.abm.policy.PolicyModel the policy model} does override
 * the first phase
 */
