 ...
 *
 * <p>This interface describes a simple Gaussian kernel function with parameters
...
public interface GaussianKernel extends KernelFunction {
	 ...
	 *
	 * <p>The raw value is computed using the formula:
	 * <pre>
	...
	public default double rawValue(int t) {
		double deltat = getMu()-t;
		return Math.exp( -( (deltat * deltat) / (2*getSigma()*getSigma()) ));
	}
