...
/**
 * Interface for simple mathematical functions that map a single input to a single output.
 * 
 * <p>Provides basic mathematical operations and supports JSON type deduction for
 * different function implementations including empirical, fixed-value, and mathematical
 * functions.
 */
