 ...
 *
 * <p>This configuration encapsulates parameters used to generate a
 * small‑world social network using the JGraphT {@code WattsStrogatzGraphGenerator}.
 * It is consumed by network construction code in the model builder during
 * the setup stage and is not used directly during simulation runtime.
 *
 * <p>Downstream uses: passed to the builder's
 ...
 *
 * <p>Extension guidance: to alter the seeding or node placement strategy
 * replace or extend the {@link io.github.ai4ci.flow.builders.DefaultNetworkSetup} implementation rather
 * than changing this configuration class.
 *
 * @author Rob Challen
 */
@Value.Immutable
...
public interface WattsStrogatzConfiguration extends NetworkConfiguration {
     ...
     *
     * @param socialNetwork an empty JGraphT SimpleGraph to populate with nodes and edges
     */
