/**
 * Configuration types and helpers that describe how a simulation population
 * and its social network are constructed.
 *
 * <p>The classes in this package provide the immutable configuration objects
 * consumed by the model builders during the setup and baselining stages. The
 * primary responsibilities are to describe:
 * <ul>
 *   <li>population level inputs such as initial imports and demographic
 *       data (see {@link io.github.ai4ci.config.setup.SetupConfiguration});</li>
 ...
 *       {@link io.github.ai4ci.config.setup.DemographicConfiguration} and
 *       its implementations {@link io.github.ai4ci.config.setup.UnstratifiedDemography},
 ...
 * <p>At experiment bootstrap the {@link io.github.ai4ci.flow.ExecutionBuilder}
 * and a concrete {@link io.github.ai4ci.flow.builders.AbstractModelBuilder}
 * consume a {@link io.github.ai4ci.config.setup.SetupConfiguration}. The
 * typical flow is:
 * <ol>
 *   <li>the builder reads {@code SetupConfiguration} and calls
 *       {@link io.github.ai4ci.config.setup.NetworkConfiguration#generateGraph}
 *       to build the social network graph during the setup stage;</li>
 *   <li>the builder uses an instance of {@link io.github.ai4ci.config.setup.DemographicConfiguration}
 *       to create person stubs (via {@link io.github.ai4ci.config.setup.DemographicConfiguration#createPersonStub})
 *       and to compute per‑pair relationship strengths;</li>
 *   <li>during baselining and initialisation the builder and specialised
 *       in‑host initialisers consult the execution configuration and the
 *       demographic/ad hoc mapping logic to set per‑person and outbreak
 *       runtime priors.</li>
 * </ol>
 *
 * <h2>Extension and composition guidance</h2>
 * <p>Prefer small, focused changes. The codebase uses a compositional pattern
 * where concrete builders such as {@link io.github.ai4ci.flow.builders.DefaultModelBuilder}
 * mix small default interfaces that implement single concerns (network setup,
 * outbreak baseliner, person baseliner, in‑host initialisers). To extend the
 * default behaviour consider one of the following approaches:
 * <ul>
 ...
 *   <li>create a custom {@code AbstractModelBuilder} or provide a factory
 *       that returns a composed builder and wire that factory into
 *       {@link io.github.ai4ci.flow.ExecutionBuilder}.</li>
 * </ul>
 *
 * <h2>Quick mapping table</h2>
 * <p>The table below is a compact guide to where common configuration
 * elements are mapped into ABM types. Use the links to navigate the code.
 *</p>
 * <table>
 * 	<caption>Mapping of configuration elements to ABM fields</caption>
 *   <tr><th>Config</th><th>Builder / method</th><th>ABM target</th></tr>
 *   <tr>
 ...
 *     <td>Populated {@link io.github.ai4ci.abm.ModifiableOutbreak} social graph</td>
 *   </tr>
 *   <tr>
 ...
 *     <td>{@link io.github.ai4ci.abm.ImmutablePersonBaseline} demographic fields</td>
 *   </tr>
 * </table>
 *
 * <p>For more detail follow the links from the builder methods to the small
 * default interfaces in {@code io.github.ai4ci.abm.builders} which contain
 * the canonical mapping logic.
 *
 * @author Rob Challen
 */
