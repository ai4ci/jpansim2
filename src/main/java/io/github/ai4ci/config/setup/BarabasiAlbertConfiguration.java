 ...
 *
 * <p>
 * This configuration is used to generate scale‑free networks via the
 ...
 *
 * <p>
 * Extension guidance: tune the degree parameter or replace the generator with a
 * custom implementation if a different degree distribution is required.
 *
 * @author Rob Challen
 */
@Value.Immutable
...
public interface BarabasiAlbertConfiguration extends NetworkConfiguration {
	 ...
	 *
	 * <p>
	 * The default values provide a compact set of parameters used in examples
	 * and tests. Downstream callers that rely on this simple default include the
	 * default setup configuration and example experiments.
	 *
