 ...
 *
 * <p>This interface provides simple helpers for demographies that incorporate
 ...
 * Implementations are used by the model builder during the setup stage to
 * place people and to inform contact probabilities between agents.
 *
 * <p>Downstream uses include {@link io.github.ai4ci.flow.builders.DefaultModelBuilder#setupOutbreak}
 ...
 *
 * <p>Extension guidance: subclasses may override {@link #getRelationshipStrength}
...
public interface LocationAwareDemography extends DemographicConfiguration {
     ...
     *
     * <p>Used by setup helpers that need a quick person object for sampling or
     * placement. Implementations may extend the returned stub further in
     * later stages.
     *
     ...
     * probability. Values above 1 compress contact radius; values below 1
     * expand it.
     *
     ...
     * proximity.
     *
     * <p>The returned value is an odds/probability modifier used by higher
     * level code when composing demographic and location based contact
     * modifiers. Implementations that need alternative kernels should override
     * this method.
     *
