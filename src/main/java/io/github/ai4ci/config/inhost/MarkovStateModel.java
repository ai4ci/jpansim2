 ...
 *
 * <p>This interface describes the distributions and parameters used by the
 ...
 *
 * <p>Downstream uses include the initialisers and builders such as
...
public interface MarkovStateModel extends InHostConfiguration, DemographicAdjustment.Markov<Distribution, Double> {
	 ...
	 *
	 * <p>This instance provides a small set of log‑normal distributions used as
	 * a baseline in examples and tests. Downstream callers that rely on a
	 * simple default include {@link io.github.ai4ci.example.Experiment}.
	 *
	 ...
	 *
	 * <p>This distribution is sampled by initialisers such as
	 * {@link io.github.ai4ci.flow.builders.DefaultInHostMarkovStateInitialiser}
	 ...
	 * {@link DemographicAdjustment.Markov} implementations that provide age‑specific
	 * adjustments to the incubation period distribution in the form of a odds ratio.
	 * 
	 ...
	 *
	 * <p>This value is not age specific in the current model. Callers include
	 * the default initialiser which samples an infectious duration for each
	 * infected individual. The distribution is not age specific in this model but may be modified
	 * by {@link DemographicAdjustment.Markov} implementations that provide age‑specific
	 * adjustments to the symptom duration distribution in the form of an odds ratio.
	 *
	 ...
	 *
	 * <p>Used by initialisers to determine how long symptomatic states last.
	 * The distribution is not age specific in this model but may be modified
	 * by {@link DemographicAdjustment.Markov} implementations that provide age‑specific
	 * adjustments to the symptom duration distribution in the form of an odds ratio.
	 *
	 ...
	 *
	 * <p>This distribution describes the expected time scale for immune waning
	 * and is sampled when determining the decay of immunity after recovery or
	 * vaccination. It is consulted by initialisers and state updaters.
	 * The distribution is not age specific in this model but may be modified
	 * by {@link DemographicAdjustment.Markov} implementations that provide age‑specific
	 * adjustments to the symptom duration distribution in the form of an odds ratio.
	 *
	 ...
	 *
	 * <p>The default implementation derives the cutoff from the
	 ...
	 *
	 * @param outbreak the current outbreak context
	 * @param configuration the execution configuration providing hospitalisation rates
	 * @return the cutoff in the unit interval [0,1] used to classify hospitalisation
	 */
