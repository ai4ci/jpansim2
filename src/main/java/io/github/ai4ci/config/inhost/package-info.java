 ...
 *
 * <p>Main purpose: provide polymorphic configuration types that describe how
 * an individual's infection progresses while inside the host. Implementations
 ...
 * </ul>
 *
 * <p>Downstream uses: the {@link io.github.ai4ci.config.execution.ExecutionConfiguration}
 * references an {@code InHostConfiguration} which is consulted during person
 * initialisation to populate per‑person {@link io.github.ai4ci.abm.inhost.InHostModelState}.
