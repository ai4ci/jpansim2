 ...
 * Example experiments.
 *
 * <p>This enum captures a set of example experiments that can be run via the
 * {@link io.github.ai4ci.example.RunExampleSim}. Each experiment is defined
 * by an {@link ImmutableExperimentConfiguration} that specifies the batch,
 * setup and execution configuration, and any facets. These configurations are
 * used by the runner to execute the experiment and generate results.
 *
 * <p>Downstream uses include example code and tests that rely on these
...
public enum Experiment {
	 ...
	 *
	 * <p>This experiment provides a compact configuration that can be used as a
...
//						// .withInHostConfiguration(StochasticModel.DEFAULT)
		...
		/**
		 * An experiment comparing different lockdown triggers and isolation severities.
		 */
	 ...
	 *
	 * <p>These fields are used by the runner to execute the experiment and
	 * generate results. The name is used in the urn base and output paths, and
	 * the configuration specifies the batch, setup and execution configuration,
	 * and any facets.
	 */
	public String name;
