...
public class InterfaceSchemaGenerator {
	 ...
	 * @param args command line arguments: [0] package name to scan, [1] output R file path
	 */
     ...
     * @throws SecurityException if a security manager is present and denies access to class information
     * @throws NoSuchMethodException  if a required method (like builder()) is not found in the immutable class
     * @param packageName the Java package to scan for @Import-annotated interfaces
     * @param outputPath the file path where the generated R code will be written
