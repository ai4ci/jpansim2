 ...
 *
 * <p>Main purpose: capture the full setup and execution configuration used for
 * a simulation execution. Records are produced at the START stage and are
 * written per execution as JSON serialisable objects; the immutable type may be
 * included alongside CSV outputs for reproducibility.
 *
 * <p>Downstream uses: used to reproduce experiments, for auditing and for
