 ...
 *
 * <p>Main purpose: provide a long format key/value listing of counts per
 * behaviour type for a simulation execution. Records are produced at the
 * UPDATE stage and are aggregated per simulation state (not per individual),
 * and written to a CSV file ({@code behaviours.csv}).
 *
 * <p>Downstream uses: aggregated behaviour counts are used for trend analysis,
