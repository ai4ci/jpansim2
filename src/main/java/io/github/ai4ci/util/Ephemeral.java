...
/** 
 * An optional value that is serializable. It is used to 
 * temporarily hold the next state of a Person or Outbreak during the update 
 * cycle, and is cleared after the cycle. It can be cloned and serialized.
 * 
...
public class Ephemeral<T> implements Serializable {
	 ...
	 *
	 * @return an Optional containing the held value, or empty if the value is null
	 */
	 ...
	 * @throws java.util.NoSuchElementException if no value is present (i.e., if the value is null)
	 */
	public T get() {
	 ...
	 *
	 * @return true if a value is present (i.e., the held value is not null), false otherwise
	 */
